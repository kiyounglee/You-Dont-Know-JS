...
**`this` is actually a binding that is made when a function is invoked, and *what* it references is determined entirely by [the call-site](#aa) where the function is called.**
